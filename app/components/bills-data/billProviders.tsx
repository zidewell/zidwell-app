  ...
  tv: [
    {
      name: "Gotv Payment",
      description:
        "Choose from a range of GOtv bouquets for your entertainment.",
      logo: "/placeholder.svg",
      color: "#00A651",
      bgColor: "bg-green-50",
    },
    ...
    },
    {
      name: "Showmax",
      description:
        "ShowMax viewing subscription bouquets for your entertainment.",
      logo: "/placeholder.svg",
      color: "#000000",
      bgColor: "bg-gray-50",
    },
...
export const billPlans: any = {
  airtime: [
    {
      ...
      price: "₦100",
      duration: "Instant",
      description: "₦100 airtime top-up",
    },
    {
      id: "air_2",
      name: "₦200 Airtime",
      ...
      price: "₦200",
      duration: "Instant",
      description: "₦200 airtime top-up",
    },
    {
      id: "air_3",
      name: "₦500 Airtime",
      ...
      price: "₦500",
      duration: "Instant",
      description: "₦500 airtime top-up",
    },
    {
      id: "mtn_1",
      name: "₦100 Airtime",
  ...
  data: [
    ...
    },
    {
      ...
      price: "₦700",
      duration: "30 days",
      description: "2GB monthly data plan",
    },
    {
      id: "data_3",
      name: "5GB Data",
    ...
    },
    {
      ...
      price: "₦500",
      duration: "30 days",
      description: "1.5GB monthly data plan",
    },
    {
      id: "mtn_data_2",
      name: "3GB Data",
      ...
      price: "₦1,000",
      duration: "30 days",
      description: "3GB monthly data plan",
    },
    {
      id: "glo_data_1",
      name: "2.5GB Data",
      ...
      price: "₦800",
      duration: "30 days",
      description: "2.5GB monthly data plan",
    },
  ],
  tv: [
    {
      ...
      price: "₦1,100",
      duration: "30 days",
      description: "Basic entertainment package",
    },
    {
      id: "gotv_2",
      name: "GOtv Max",
    ...
    },
    {
      ...
      price: "₦7,900",
      duration: "30 days",
      description: "Standard entertainment package",
    },
    {
      id: "dstv_2",
      name: "DStv Premium",
    ...
    },
    {
      ...
      price: "₦1,200",
      duration: "30 days",
      description: "Mobile streaming plan",
    },
    {
      id: "showmax_2",
      name: "Showmax Pro",
      ...
      price: "₦3,200",
      duration: "30 days",
      description: "Full streaming plan with sports",
    },
  ],
  electricity: [
    {
      ...
      name: "Prepaid Units",
      provider: "IKEDC",
      type: "Electricity Units",
      price: "Variable",
      duration: "As consumed",
      description: "Prepaid electricity units",
    },
    {
      id: "ikedc_2",
      name: "Postpaid Bill",
