...
export const ContractSuccessModal: React.FC<ContractSuccessModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-(--bg-primary) rounded-xl p-4 sm:p-6 sm:max-w-lg md:max-w-4xl w-full mx-auto shadow-pop max-h-[90vh] overflow-y-auto border border-(--border-color) squircle-lg">
        {/* Header Section */}
