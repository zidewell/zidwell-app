...
const HowItWorks: React.FC = () => (
    <section className="border border-[var(--border-color)] rounded p-4 mb-6 bg-[var(--bg-primary)]">
        <h3 className="text-sm font-medium text-[var(--text-primary)]">How It Works</h3>
        <p className="text-xs text-[var(--text-secondary)] mt-1">Three simple steps to get your contract signed</p>
