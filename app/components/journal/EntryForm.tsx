...
export function EntryForm({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md max-h-[90vh] overflow-y-auto bg-(--bg-primary) border border-(--border-color) shadow-soft squircle-lg">
        <DialogHeader>
          <DialogTitle
        ...
        <form onSubmit={handleSubmit} className="space-y-5 mt-4">
            ...
            <Popover>
              <PopoverTrigger asChild>
                <Button
                  variant="outline"
                  className={cn(
                    "w-full justify-start text-left font-normal border-(--border-color) bg-(--bg-primary) text-(--text-primary)",
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className="text-lg font-semibold border-(--border-color) bg-(--bg-primary) text-(--text-primary) focus:ring-(--color-accent-yellow) focus:border-(--color-accent-yellow)"
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="text-xs hover:underline flex items-center gap-1 text-(--color-accent-yellow)"
              >
            ...
            {showNewCategory && (
              <div className="flex gap-2 p-3 rounded-xl mb-2 bg-(--bg-secondary)">
                <Input
                ...
                <Button
                  ...
                  className="shrink-0 bg-(--color-accent-yellow) text-(--color-ink) hover:bg-(--color-accent-yellow)/90 squircle-md"
          ...
          <Button
            type="submit"
            className="w-full font-semibold bg-(--color-accent-yellow) text-(--color-ink) hover:bg-(--color-accent-yellow)/90 squircle-md shadow-soft"
