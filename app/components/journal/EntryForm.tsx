// app/components/journal/EntryForm.tsx
...
export function EntryForm({ open, onOpenChange, defaultType = 'expense', editEntry }: EntryFormProps) {
  const { categories, addEntry, updateEntry, activeJournalType, addCategory } = useJournal();
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-2xl md:max-w-3xl w-[95vw] max-h-[90vh] overflow-y-auto bg-(--bg-primary) border border-(--border-color) shadow-soft squircle-lg p-4 sm:p-6">
        <DialogHeader>
          <DialogTitle
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6">
            ...
            <div className="space-y-2">
              ...
              <Popover>
                ...
                <PopoverContent className="w-auto p-0 z-50 bg-(--bg-primary) border border-(--border-color) shadow-soft squircle-md" align="start">
                  <Calendar
                    mode="single"
                    selected={date}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2 md:gap-3 max-h-60 overflow-y-auto pr-1">
              {sortedCategories.map((cat) => (
                ...
                >
                  ...
                  <span className="text-2xl md:text-3xl text-(--text-primary)">{cat.icon}</span>
