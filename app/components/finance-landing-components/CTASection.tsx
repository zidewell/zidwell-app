...
const CTASection = () => {
  ...
  return (
    <section className="py-20 md:py-28 lg:py-32 relative overflow-hidden bg-gold-gradient-subtle">
      ...
      <div className="absolute top-10 left-10 w-20 h-20 border-2 border-[#2b825b] rotate-45 opacity-30" />
      <div className="absolute bottom-10 right-10 w-32 h-32 bg-[#2b825b]/10 rounded-full" />
      <div className="absolute top-1/2 left-1/4 w-4 h-4 bg-[#2b825b]" />
      <div className="absolute bottom-1/3 right-1/3 w-24 h-24 bg-linear-to-br from-[#2b825b]/20 to-transparent rounded-full blur-xl" />
          ...
          <div className="bg-neutral-900 text-white p-8 md:p-12 border-2 border-neutral-900">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button2
                ...
                className="bg-[#2b825b] text-neutral-900 border-white group"
              >
                Get Started
