      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="bg-white text-neutral-900 border-2 border-white p-8 md:p-10 relative">
            <div className="absolute -top-4 -left-4 w-12 h-12 bg-(--color-accent-yellow) border-2 border-neutral-900 flex items-center justify-center font-black text-xl">
              1
            </div>
            ...
            <div className="pt-4">
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-start gap-3">
                  <span className="w-6 h-6 bg-(--color-accent-yellow) shrink-0 flex items-center justify-center text-sm font-bold mt-0.5">
                    ✓
                  </span>
          ...
          <div className="bg-(--color-accent-yellow) text-neutral-900 border-2 border-neutral-900 p-8 md:p-10 relative shadow-[8px_8px_0px_hsl(0,0%,100%)]">
