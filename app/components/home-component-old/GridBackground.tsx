    ...
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      >
        ...
        {[...Array(12)].map((_, i) => (
          <path
            key={`h-${i}`}
            d={`M0 ${60 + i * 60} Q300 ${30 + i * 60} 600 ${60 + i * 60} T1200 ${60 + i * 60}`}
            fill="none"
      ...
      <div className="absolute inset-0 bg-linear-to-b from-(--color-accent-yellow)/5 via-transparent to-transparent" />
    </div>
  );
};
