...
<body>
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-[var(--bg-primary)] rounded-xl p-6 max-w-2xl w-full mx-4 shadow-pop max-h-[90vh] overflow-y-auto border border-[var(--border-color)] squircle-lg">
        ...
        <div className="space-y-4 py-4">
          {/* Download Option */}
          <div className="rounded-lg border-2 border-[var(--border-color)] p-4 hover:border-[var(--color-accent-yellow)] transition-colors squircle-md">
            <div className="flex items-start gap-4">
              <div className="h-10 w-10 rounded-lg bg-[var(--bg-secondary)] flex items-center justify-center shrink-0">
                <FileText className="h-5 w-5 text-[var(--text-secondary)]" />
              </div>
              <div className="flex-1">
                <h3 className="font-medium text-[var(--text-primary)]">Download PDF</h3>
                ...
                <Button
                  ...
                  className="mt-3 bg-[var(--color-accent-yellow)] text-[var(--color-ink)] hover:bg-[var(--color-accent-yellow)]/90 min-w-[140px] squircle-md"
                >
                  {isDownloading ? (
                    <>
          ...
          {signingLink && (
            <div className="rounded-lg border-2 border-[var(--border-color)] p-4 hover:border-[var(--color-accent-yellow)] transition-colors squircle-md">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="font-medium text-[var(--text-primary)]">Share Receipt Link</h3>
                  <p className="text-sm text-[var(--text-secondary)] mt-1">
                    Send this link to the receiver. They can view and acknowledge the receipt.
                  </p>
                  <div className="flex gap-2 mt-3">
                    <div className="flex-1 rounded-lg bg-[var(--bg-secondary)] px-3 py-2 text-sm font-mono text-[var(--text-secondary)] truncate">
                      {signingLink}
                    </div>
                    <Button
                      variant="outline"
                      ...
                      className="shrink-0 border-[var(--border-color)] text-[var(--text-primary)] hover:bg-[var(--bg-secondary)] squircle-sm"
                      disabled={isDownloading}
                    >
                      {copied ? (
        ...
        <div className="mt-4 p-3 bg-[var(--bg-secondary)] rounded-lg squircle-md">
