    ...
    <section className="relative overflow-hidden">
      <div className="container relative py-16 sm:py-24">
        <div className="max-w-2xl mx-auto text-center animate-fade-in">
          <div className="inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-sm font-medium mb-6 bg-[var(--color-accent-yellow)]/15 border border-[var(--color-accent-yellow)]/30 text-[var(--color-accent-yellow)]">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold text-[var(--text-primary)] mb-4 tracking-tight">
            ...
            <span className="text-[var(--color-accent-yellow)]">Prove Delivery</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/dashboard/services/receipt/create-receipt">
              <Button
                size="lg"
                className="w-full sm:w-auto bg-[var(--color-accent-yellow)] hover:bg-[var(--color-accent-yellow)]/90 text-[var(--color-ink)] squircle-md"
              >
