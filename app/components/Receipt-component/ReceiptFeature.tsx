        ...
        <div className="grid gap-6 sm:grid-cols-3 max-w-4xl mx-auto">
          {[
            ...
            },
            {
              ...
              description: "Create and sign receipts on any device, anywhere.",
            },
          ].map((feature, index) => (
            <div
              key={feature.title}
              className="p-6 rounded-xl bg-(--bg-primary) border border-(--border-color) transition-all duration-300 animate-slide-up hover:border-(--color-accent-yellow)/80 hover:shadow-soft squircle-lg"
              style={{ animationDelay: `${index * 0.1}s` }}
            >
              <div className="h-12 w-12 rounded-lg flex items-center justify-center mb-4 bg-(--color-accent-yellow)/15">
