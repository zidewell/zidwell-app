    ...
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        ...
        <Button
          ...
          size="sm"
          onClick={addItem}
          className="border-(--color-accent-yellow) text-(--color-accent-yellow) hover:bg-(--color-accent-yellow)/10 squircle-sm"
          disabled={disabled}
        >
          Add Item
        </Button>
      ...
      {items.map((item, index) => (
        <div
          key={item.id}
          className="grid grid-cols-1 md:grid-cols-12 gap-4 p-4 border rounded-lg border-(--border-color) squircle-md"
        >
          ...
          <div className="md:col-span-2">
            ...
            <div className="mt-1.5 p-2 border rounded bg-(--bg-secondary) text-(--text-primary) font-medium border-(--border-color)">
      ...
      {items.length === 0 && !disabled && (
        <div className="text-center py-8 border-2 border-dashed border-(--border-color) rounded-lg squircle-lg">
