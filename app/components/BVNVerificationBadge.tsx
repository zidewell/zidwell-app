...
const BVNVerificationBadge = ({ className = "" }: BVNVerificationBadgeProps) => {
  ...
  return (
    <div className={`sticky top-0 left-0 right-0 z-50 w-full ${className}`}>
      <div className={`w-full px-4 py-3 border-b shadow-sm ${
        isPending 
          ...
          <div className="flex-1 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            {isNotSubmitted && (
              <Button
                ...
                size="sm"
                className="bg-[#C29307] hover:bg-[#a67905] text-white h-8 text-xs whitespace-nowrap"
              >
