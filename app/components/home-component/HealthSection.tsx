      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-5">
            ...
            <h2 className="mt-5 font-display text-4xl sm:text-5xl font-semibold tracking-tight text-(--text-primary)">Business isn't just about making money. It's also about how you ACCOUNT for it.</h2>
            <p className="mt-4 text-(--text-secondary)">A live Financial Health Score paired with intelligent, plain-English insights — so you can make better decisions, faster.</p>
