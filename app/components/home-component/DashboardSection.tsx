      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-10 items-end">
          <div className="lg:col-span-5">
            ...
            <h2 className="mt-3 font-display text-4xl sm:text-5xl font-semibold tracking-tight text-(--text-primary)">A dashboard that doesn't feel like accounting.</h2>
            <p className="mt-4 text-(--text-secondary)">Pie charts. Income vs expenses. Net balance. Monthly trends. Real figures in your currency — designed for humans, not auditors.</p>
            <div className="mt-6 flex items-center gap-3">
              ...
              <div><p className="font-display text-base font-semibold text-(--text-primary)">Loved by founders</p><p className="text-xs text-(--text-secondary)">From market stalls to tech studios.</p></div>
            </div>
          </div>
