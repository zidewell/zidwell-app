      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-10 items-start">
          <div className="lg:col-span-5">
            ...
            <h2 className="mt-5 font-display text-4xl sm:text-5xl font-semibold tracking-tight text-(--text-primary)">For corporations, agencies and structured teams.</h2>
            <p className="mt-4 text-(--text-secondary)">Give the right people the right access. Approve the right actions. Keep a clean record of everything that touches your money.</p>
          </div>
