...
function Donut() {
  ...
  return (
    <svg viewBox="0 0 120 120" className="h-36 w-36">
      ...
      <text x="60" y="58" textAnchor="middle" fill="var(--foreground)" style={{ fontSize: 11, fontWeight: 600 }}>
        ₦ 3.4M
      </text>
      <text x="60" y="72" textAnchor="middle" fill="var(--muted-foreground)" style={{ fontSize: 8 }}>
        total spent
      </text>
    </svg>
  );
...
function Stat({ label, value, tone }: { label: string; value: string; tone?: "leaf" | "gold" }) {
