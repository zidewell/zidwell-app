...
export function AISection() {
  return (
    <section id="ai" className="py-24 sm:py-32 bg-[var(--color-ink)] text-[var(--bg-primary)] relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-5">
            <span className="inline-flex items-center gap-2 rounded-full bg-white/10 border border-white/15 px-3 py-1.5 text-xs">
              <Sparkles className="h-3.5 w-3.5 text-[var(--color-accent-yellow)]" /> Coming soon
            </span>
