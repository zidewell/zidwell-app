...
import { UserPlus, Wallet, TrendingUp, ArrowRight, Shield, Check } from "lucide-react";
...
// Fallback images if you don't have the actual images yet
const stepImages = {
  step1: "https://images.unsplash.com/photo-1585490931726-a7784b1575a5?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8YmxhY2slMjBtZW4lMjB3cml0aW5nfGVufDB8fDB8fHww",
  step2: "https://images.unsplash.com/photo-1625191824973-894292e94c96?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8YmxhY2slMjBtZW4lMjBpbm1hcmtldHxlbnwwfHwwfHx8MA%3D%3D",
  step3: "https://images.unsplash.com/photo-1585490931726-a7784b1575a5?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8YmxhY2slMjBtZW4lMjB3cml0aW5nfGVufDB8fDB8fHww",
};
...
const HowItWorks = () => {
  return (
    <section id="how-it-works" className="relative overflow-hidden border-t border-[var(--border-color)] bg-[var(--bg-primary)] py-20 md:py-32">
      {/* Background blobs */}
      <div className="absolute -left-32 top-20 -z-10 h-80 w-80 rounded-full bg-[var(--color-accent-yellow)]/20 blur-3xl animate-blob" />
      <div className="absolute -right-32 bottom-10 -z-10 h-80 w-80 rounded-full bg-[var(--color-accent-yellow)]/15 blur-3xl animate-blob" style={{ animationDelay: "-4s" }} />
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
          ...
          <p className="max-w-sm text-sm text-[var(--text-secondary)]">
            Three simple steps to financial clarity. From setup to growth, Zidwell handles the structure while you focus on what matters.
          </p>
        </div>
          ...
          {steps.map((step, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Card Content */}
                <div className={`flex flex-1 flex-col p-6 ${isInk ? "bg-[var(--color-ink)]" : "bg-[var(--bg-primary)]"}`}>
                  {/* Icon */}
                  <div
                  ...
                  {/* Title */}
                  <h3 className={`font-display text-xl font-bold ${isInk ? "text-[var(--color-white)]" : "text-[var(--text-primary)]"}`}>
                    {step.title}
                  </h3>

                  {/* Description */}
                  <p className={`mt-2 text-sm ${isInk ? "text-[var(--color-white)]/75" : "text-[var(--text-secondary)]"}`}>
                    {step.description}
                  </p>
                  ...
                  >
                    <span className={`group/btn inline-flex w-full items-center justify-center gap-1.5 rounded-full px-4 py-2.5 text-sm font-bold transition-transform hover:-translate-y-0.5 ${
                      isInk
        ...
        <div className="mt-10 rounded-2xl border border-dashed border-[var(--border-color)] bg-[var(--bg-secondary)]/60 p-6">
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div key={feature} className="flex items-center gap-2.5 text-sm font-medium text-[var(--text-primary)]">
