    ...
    <div className="flex flex-col sm:flex-row sm:items-center md:items-end justify-between p-3 sm:p-4 border rounded-lg bg-gray-50 gap-3 sm:gap-4">
      ...
      <div className="shrink-0">
        <button
          ...
          className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-(--color-accent-yellow) focus:ring-offset-2 ${
            isActive ? "bg-(--color-accent-yellow)" : "bg-gray-200"
          }`}
        >
          <span
