...
const DigitalFields = ({ downloadUrl, setDownloadUrl, accessLink, setAccessLink, emailDelivery, setEmailDelivery }: Props) => (
  <div className="space-y-6">
    <div>
      <Label className="text-sm font-semibold mb-2 block">Download URL</Label>
      <Input placeholder="https://drive.google.com/file/..." value={downloadUrl} onChange={(e) => setDownloadUrl(e.target.value)} className="h-12 text-base" />
    ...
    <div>
      ...
      <Input placeholder="https://your-course.com/access" value={accessLink} onChange={(e) => setAccessLink(e.target.value)} className="h-12 text-base" />
