...
export async function GET(
  ...
  try {
    ...
    const description =
      post?.excerpt || "Finance & Business Tools for Nigerian SMEs";
      ...
      >
        ...
        <div
          style={{
            ...
            bottom: 0,
            backgroundImage:
              "radial-gradient(circle at 25px 25px, #E6E6E6 2px, transparent 2px)",
        ...
        <div
          style={{
            ...
            bottom: 0,
            background:
              "linear-gradient(135deg, rgba(43,130,91,0.05) 0%, rgba(0,0,0,0) 100%)",
          }}
        />
    ...
    return new ImageResponse(
      <div
        style={{
          ...
          alignItems: "center",
          justifyContent: "center",
          background: "linear-gradient(135deg, #FDC020 0%, #1e5e43 100%)",
        }}
      >
        <div
          style={{
