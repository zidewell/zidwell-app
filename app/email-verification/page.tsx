    ...
    <div className="flex flex-col justify-center items-center min-h-screen bg-gray-50 p-4">
      <div className="bg-white shadow-md rounded-xl p-8 w-full max-w-md text-center">
        ...
        <button
          ...
          disabled={loading}
          className="w-full bg-(--color-accent-yellow) text-white py-3 rounded-lg mb-3 hover:bg-[#a67905] transition"
        >
        ...
        <button
          ...
          disabled={loading}
          className="w-full border border-(--color-accent-yellow) text-(--color-accent-yellow) py-3 rounded-lg hover:bg-[#FFF5D9] transition"
        >
