      ...
      <div className="min-h-screen relative bg-linear-to-br from-[#FDF8ED] to-white">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row min-h-screen">
          ...
          <aside className="w-full lg:w-[30%] xl:w-[28%] bg-white/80 backdrop-blur-sm border-b lg:border-b-0 lg:border-r border-gray-200 p-6 lg:p-8 xl:p-10 flex flex-col">
            {/* Logo */}
            <div
              className="mb-8 opacity-0 animate-slide-in-left"
            ...
            <div className="space-y-4 mb-8">
              ...
              >
                This short form helps us understand your business, your numbers,
            ...
            >
              <p className="text-sm text-gray-900 font-medium">
                We don't believe in generic accounting or copy-and-paste
                solutions.
              </p>
              <p className="text-sm text-gray-600 leading-relaxed">
                Every business is different — your size, revenue, industry, and
                challenges all matter. The information you share here allows our
                finance team to:
              </p>
