        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-56 rounded-2xl bg-card border-border shadow-xl">
            ...
            <DropdownMenuItem onClick={handleCopyUrl} className="cursor-pointer">
              <LinkIcon className="size-4 mr-2" /> Copy URL
            </DropdownMenuItem>
            <DropdownMenuSeparator />
            <DropdownMenuItem 
...
export default function PaymentPage() {
  ...
  useEffect(() => {
    ...
    const initialize = async () => {
      try {
        ...
        // Step 2: If store exists, fetch pages
        if (store || hasStore) {
          await fetchPages();
          if (isMounted) {
  ...
  // ============================================================
  // Handle refresh with throttling for scalability
  // ============================================================
  ...
  // ============================================================
  // ✅ FIXED: Single loader state - show loader until everything is ready
  // ============================================================
  ...
  // ============================================================
  // ✅ SHOW STORE CREATION FORM FOR USERS WITHOUT A STORE
  // ============================================================
  if (!hasStore && !store) {
    return (
      <div className="min-h-screen bg-background">
