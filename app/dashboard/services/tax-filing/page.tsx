...
function TaxFilingPage() {
  ...
  const getTierInfo = () => {
    ...
    if (isPremiumUser) return { icon: Crown, color: 'text-[var(--color-accent-yellow)]', bg: 'bg-[var(--color-accent-yellow)]/10', label: 'Premium' };
    if (isGrowthUser) return { icon: Zap, color: 'text-[var(--color-accent-yellow)]', bg: 'bg-[var(--color-accent-yellow)]/10', label: 'Growth' };
    if (isZidLiteUser) return { icon: Zap, color: 'text-blue-600', bg: 'bg-blue-100 dark:bg-blue-900/20', label: 'ZidLite' };
    return { icon: Star, color: 'text-[var(--text-secondary)]', bg: 'bg-[var(--bg-secondary)]', label: 'Free Trial' };
  };
            ...
            <div className="max-w-5xl mx-auto">
              ...
              {hasTaxSupport && (
                <div className="mt-8 grid md:grid-cols-2 gap-6">
                  <div className="bg-[var(--bg-primary)] border-2 border-[var(--border-color)] rounded-md p-6 shadow-soft hover:shadow-pop transition-all">
                    <h3 className="font-bold text-lg text-[var(--text-primary)] mb-3">Tax Filing Support</h3>
                    <p className="text-[var(--text-secondary)] mb-4">Get help filing your taxes with our experts</p>
                    <Link href="/dashboard/services/tax-filing/support">
                      <Button className="w-full bg-[var(--color-accent-yellow)] text-[var(--color-ink)] hover:bg-[var(--color-accent-yellow)]/90 border-2 border-[var(--border-color)] shadow-soft active:shadow-none transition-all">
                        Start Filing
                      </Button>
                    </Link>
                  </div>
                  <div className="bg-[var(--bg-primary)] border-2 border-[var(--border-color)] rounded-md p-6 shadow-soft hover:shadow-pop transition-all">
                    <h3 className="font-bold text-lg text-[var(--text-primary)] mb-3">Financial Statements</h3>
                    <p className="text-[var(--text-secondary)] mb-4">Generate P&L, Balance Sheet, and Cash Flow</p>
              ...
              {hasFullTaxFiling && (
                <div className="mt-8 grid md:grid-cols-3 gap-6">
                  <div className="bg-[var(--bg-primary)] border-2 border-purple-200 dark:border-purple-800 rounded-md p-6 shadow-soft hover:shadow-pop transition-all">
                    <h3 className="font-bold text-lg text-[var(--text-primary)] mb-3">VAT Filing</h3>
                    <p className="text-[var(--text-secondary)] mb-4">File your VAT returns</p>
                    <Link href="/dashboard/services/tax-filing/vat">
                      <Button className="w-full bg-purple-600 hover:bg-purple-700 text-white border-2 border-[var(--border-color)] shadow-soft active:shadow-none transition-all">
                        File VAT
                      </Button>
                    </Link>
                  </div>
                  <div className="bg-[var(--bg-primary)] border-2 border-purple-200 dark:border-purple-800 rounded-md p-6 shadow-soft hover:shadow-pop transition-all">
                    <h3 className="font-bold text-lg text-[var(--text-primary)] mb-3">PAYE Filing</h3>
                    <p className="text-[var(--text-secondary)] mb-4">File employee taxes</p>
                  ...
                  <div className="bg-[var(--bg-primary)] border-2 border-purple-200 dark:border-purple-800 rounded-md p-6 shadow-soft hover:shadow-pop transition-all">
                    <h3 className="font-bold text-lg text-[var(--text-primary)] mb-3">WHT Filing</h3>
                    <p className="text-[var(--text-secondary)] mb-4">Withholding tax filing</p>
